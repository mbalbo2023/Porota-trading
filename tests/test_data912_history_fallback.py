...
def test_scheduler_keeps_internal_historical_writes_disabled():
    ...
    assert az_maintenance_scheduler.INTERNAL_HISTORICAL_WRITE_JOBS == frozenset({
        "historical_refresh", "historical_refresh_if_needed",
    })
