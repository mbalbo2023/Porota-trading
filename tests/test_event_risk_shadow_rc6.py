...
def test_event_not_visible_before_engine_availability(): assert m.backtest_view(event(),as_of='2026-09-07T10:00:04+00:00')['status']=='NOT_YET_KNOWN'
def test_later_confirmation_is_not_backdated():
    e=event(); r=m.backtest_view(e,as_of='2026-09-07T10:10:00+00:00'); assert r['status']=='AVAILABLE' and not r['confirmed']; assert m.backtest_view(e,as_of='2026-09-07T10:21:00+00:00')['confirmed']
def test_available_filter_preserves_temporal_order():
    e1=event(event_id='E1',available_to_engine_at='2026-09-07T10:01:00+00:00'); e2=event(event_id='E2',available_to_engine_at='2026-09-07T10:02:00+00:00',first_seen_at='2026-09-07T10:01:30+00:00'); assert [x.event_id for x in m.evidence_available([e2,e1],as_of='2026-09-07T10:01:30+00:00')]==['E1']
