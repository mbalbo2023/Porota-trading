...
def test_point_in_time_audit_never_uses_future_versions(tmp_path):
    ...
    c.execute("INSERT INTO paper_learning_samples VALUES(?,?)",("p","2026-09-23T15:00:00+00:00"))
    ...
    # duplicate version of an already existing bar: only the latest known <= as_of may count
    revised=json.dumps({"quality":"COMPLETE","synthetic":False,"open":101,"high":102,"low":100,"close":101,"volume":10})
    c.execute("INSERT INTO candle_versions VALUES(98,1,?,?,?,?)",(revised,"2026-09-23T14:55:00+00:00","2026-09-23T13:00:00+00:00","2026-09-23T13:00:00+00:00"))
