...
INTERNAL_JOBS = (
    ...
    InternalJob("PPI_PRODUCTION_CATALOG", "Catálogo PPI",
                "Refresco preapertura y cierre de identidad, moneda, lote y reglas PPI.", 24*3600),
    InternalJob("PPI_FOCUS_QUOTES", "PPI cotizaciones foco",
                "PPI primario cada minuto para instrumentos/estrategias SHADOW en evaluación.", 60,
                "Sólo rueda operable; no envía órdenes."),
    InternalJob("PPI_UNIVERSE_COVERAGE", "PPI cobertura universo",
                "Barrido rotativo PPI cada 15 min para completar evidencia del universo SHADOW.", 15*60,
                "Sólo rueda operable; no envía órdenes."),
    InternalJob("IOL_MISSING_FIELDS", "IOL faltantes",
                "Consulta IOL sólo cuando PPI no entrega un campo o hay inconsistencia pendiente.", 5*60,
                "Sólo rueda operable y por demanda de faltantes."),
    InternalJob("BYMA_STRUCTURED_CAPTURE", "BYMA captura estructurada",
                "Completa sólo campos públicos aún ausentes tras PPI e IOL, incluyendo VWAP.",
                int(os.getenv("PUBLIC_STRUCTURED_CAPTURE_SECONDS", "900")),
                "Cada 15 min durante rueda y snapshot de cierre; SHADOW_ONLY."),
