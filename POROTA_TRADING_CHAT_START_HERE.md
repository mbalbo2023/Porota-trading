...
La copia cross-chat conserva íntegro `POROTA_TRADING_CHECKPOINT_ACTIVE_READY_2026-09-14.md` y agrega el delta de la captura contractual reciente. Los checkpoints de operabilidad por familia agregan el diseño multi-source PPI + IOL y deben prevalecer para esa línea de trabajo cuando exista evidencia posterior. El blueprint integral organiza la implementación por WAVE y por instrumento patrón. Si evidencia nueva cambia el estado, actualiza primero el checkpoint sin borrar el antecedente.
