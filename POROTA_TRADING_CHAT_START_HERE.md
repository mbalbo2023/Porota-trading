...
5. Aplica el esfuerzo mínimo suficiente según riesgo; paraleliza sólo tareas independientes y aisladas, sin omitir las comprobaciones obligatorias.
6. Si se solicitan chats anteriores, consulta los últimos diez sólo si existe acceso a sus transcripciones; si no, decláralo y limita conclusiones a GitHub/evidencia disponible.
7. Continúa sólo dentro del alcance y permisos documentados. Actualiza el checkpoint con cada hito material y verifica el commit en GitHub.
