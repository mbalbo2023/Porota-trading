"""RC6 read-only provider for learning-policy observational inputs.

Builds expectancy, breadth/regime and reviewed sector observations from the same
ledger sources used by operational introspection. It never changes
configuration, never grants READY_PAPER, never self-promotes a policy and never
routes an order.
"""
...
def collect(store, *, at=None, candidate=None) -> dict:
    ...
    return {
        ...
        "source": "RC6_POLICY_CONTEXT_READONLY",
    }
