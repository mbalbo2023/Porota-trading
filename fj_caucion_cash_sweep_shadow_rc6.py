...
def shadow_cash_sweep(
    ...
    *,
    ...
    # Automatic/shadow evaluation uses only offers with an exact fee budget,
    # matching the existing PAPER runtime safety policy. Unknown fee curves are
    # never extrapolated into an apparently profitable sweep.
    verified = [
