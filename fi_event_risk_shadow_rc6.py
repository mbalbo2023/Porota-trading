...
class EventEvidence:
    ...
    def validate(self):
        ...
        # Engine cannot know the event before first observation; publication may predate ingestion.
...
def backtest_view(event:EventEvidence, *, as_of)->dict:
    ...
    # Later confirmation/retraction must not leak into an earlier replay point.
